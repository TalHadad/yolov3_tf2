...
from  import Dense, Dropout, Input
from keras.models import Model

# Here I prepare two hidden layers neural network with dropout.
# I used Keras Functional API.
def make_model(inps=10):
    inputs    = keras.layers.Input(shape=(inps, ))
    dense_1   = keras.layers.Dense(10, activation='sigmoid', init='glorot_uniform')(inputs)
    dropout_1 = keras.layers.Dropout(0.1)(dense_1)
    output    = keras.layers.Dense(3, activation='softmax', init='glorot_uniform')(dropout_1)
